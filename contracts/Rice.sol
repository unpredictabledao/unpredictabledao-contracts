...
contract Rice {
    ...
    function reveal(uint subIndex, uint realValue, bytes32 dummyValue) public {
    ...
    event GenerateNumber(uint number, uint campaignIndex);
    ...
    function collectReward(uint subIndex) public {
        require(
    ...
    function voteOnCallerFee(uint64 fee, uint256 amount) public {
    ...
    function withdrawOnCallerFee(uint256 fee) public {
        (bool _success, ) = tokenAddress.call(
            abi.encodeWithSignature(
